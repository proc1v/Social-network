...
namespace Social_network.DAL
{
    public class CommandMongoDB
    {
        static string ConnectionString
        {
            get
            {
                return new ConfigurationBuilder().AddJsonFile(@"F:\Універ\Лаби\NoSQL Course\Social-network\Social-network\appsettings.json").Build().GetConnectionString("SN-mongodb");
            }
        }
