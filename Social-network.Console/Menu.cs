...
using Social_network.DAL.EntetiesMongoDB;
using System;
using System.Collections.Generic;
using System.Linq;

namespace Social_network.ConsoleProgram
{
    public class Menu
    {
        ...
        private void showSearchedUserInfoMenu(User user)
        {
            ...
            while (userInput != '0')
            {
                ...
                selectSearchedMenuInput(userInput, user);
            }
        }
        ...
        private void selectSearchedMenuInput(char userInput, User user)
        {
            switch (userInput)
            {
                case '1':
        ...
        private void unFollowMenuCommand()
        {
            string selected;
            bool? success;
            Console.Write("\nWrite username : ");
